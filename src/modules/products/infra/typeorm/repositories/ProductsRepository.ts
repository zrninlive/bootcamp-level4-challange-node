...
class ProductsRepository implements IProductsRepository {
  ...
  public async findAllById(product_ids: IFindProducts[]): Promise<Product[]> {
    const products = await this.ormRepository.findByIds(product_ids);
  ...
  public async updateQuantity(
    ...
    const productsUpdated = productsData.map(productData => {
      ...
      const productUpdate = {
        ...productData,
        quantity: productData.quantity - productFind.quantity,
      };
